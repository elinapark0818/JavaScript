...
다른방법(조금 더 지저분해보이지만..)
 ...
 console.log(color);
 console.log(cuteSlime);  // color를 제외한 값이 나온당

 const { attribute, ...slime } = cuteSlime;
 console.log(attribute);
 console.log(slime);  //attribute를 제외한 값이 나온당
배열에서 rest 사용하기
 const oneToSix = [1,2,3,4,5,6];
 const [one1, two2, ...rest] = oneToSix;

 console.log(one1);
 console.log(two2);
 console.log(rest);
함수에서 rest 사용하기
 function ssum(a, b, c, d, e, f, g) {
     let ssum = 0;
     if (a) ssum += a;
     if (b) ssum += b;
     if (c) ssum += c;
